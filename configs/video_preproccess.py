...
#------------------------ LayoutBbox ------------------------#
import os
salient_path = os.path.join(folder_paths.models_dir,'salient')
ram_tag_list_path = os.path.join(os.path.dirname(__file__), '..', 'ram_tag_color_list.txt')
...
video_layout_bbox_anno.RAM_TAG_COLOR_PATH = ram_tag_list_path
...
video_layout_track_anno.RAM_TAG_COLOR_PATH = ram_tag_list_path
video_layout_track_anno.INPAINTING = {"MODE": "all",
                                      "SALIENT": {"PRETRAINED_MODEL": os.path.join(salient_path,'u2net.pt')},
                                      "GDINO": {"TOKENIZER_PATH": os.path.join(gdino_path,'bert-base-uncased'),
                                                "CONFIG_PATH": os.path.join(gdino_path,'GroundingDINO_SwinT_OGC.cfg.py'),
                                                "PRETRAINED_MODEL": os.path.join(gdino_path,'groundingdino_swint_ogc.pth')},
                                      "SAM2": {"CONFIG_PATH": os.path.join(sam2_path,'configs','sam2.1','sam2.1_hiera_l.yaml'),
                                               "PRETRAINED_MODEL": os.path.join(sam2_path,'sam2.1_hiera_large.pt')}}
